<?php
/* -----------------------------------------------------------------------------------------
   $Id: boxes.php 16486 2025-06-23 11:06:13Z GTB $
...
if (in_array($display_mode, $fullcontent)) {
...
$smarty->assign('logo_path', DIR_WS_BASE . 'templates/' . CURRENT_TEMPLATE . '/' . BS5_SHOP_LOGO);
...
if (
  !defined('MODULE_NEWSLETTER_STATUS')
...
// -----------------------------------------------------------------------------------------
if (
  in_array($display_mode, array('logoff', 'error', 'shoppingcart', 'newsletter'))
