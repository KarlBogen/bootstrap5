    ...
    <div class="blogentry">
      <div class="blog_desc">
        ...
        <div class="banner_config">
          ...
          '.TEXT_BANNER_IMAGES_WIDTH.' 966 Pixel ("fullcontent" 1296 Pixel)<br>
          '.TEXT_BANNER_IMAGES_HEIGHT.' 400 Pixel<br> 
          '.TEXT_BANNER_IMAGES_WIDTH_MOBILE.' 530 Pixel<br>
          '.TEXT_BANNER_IMAGES_HEIGHT_MOBILE.' 300 Pixel
        </div>  

        <div class="banner_headline">'.TEXT_SLIDER.'</div>
        <table class="banner">
          <tr>
            <td style="width:100%">'.TEXT_BANNER_GROUP.' <b>'.TEXT_SLIDER.'</b><br>('.TEXT_WIDTH.' 100%)<br>'.TEXT_DESKTOP.' 966 x 400 Pixel ("fullcontent" 1296 x 400 Pixel)<br>'.TEXT_MOBILE.' 530 x 300 Pixel</td>
          </tr>
        </table>
