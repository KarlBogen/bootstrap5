  ...
  <body>
    ...
    <table class="tableBody bs5">
      <tr>
        ...
        <td class="boxCenter">
          <?php // updateinfo
          if (!defined('MODULE_BS5_TPL_MANAGER_VERSION') || version_compare(MODULE_BS5_TPL_MANAGER_VERSION, '1.2.6', '<')) {
                ...
                ?>
                  <div class="admincol_left">
                    <table class="clear tableConfig">
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_CLASSES; ?></h3>
                        </td>
                      </tr>
                      <tr>
                ...
                ?>
                  <div class="admincol_left">
                    <table class="clear tableConfig">
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_SUPERFISHMENU; ?></h3>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_ALL_MENUS; ?></h3>
                        </td>
                      </tr>
                      <tr>
                ...
                ?>
                  <div class="admincol_left">
                    <table class="clear tableConfig">
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_STARTPAGE_BOXES; ?></h3>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_NOT_STARTPAGE_BOXES; ?></h3>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_BOXES; ?></h3>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="dataTableConfig col-left"><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_SHOW_PAYPAL_IN_BOX_CART; ?></td>
                        <td class="dataTableConfig col-middle"><?php echo xtc_cfg_select_option($yes_no_array, $bs5_conf['BS5_SHOW_PAYPAL_IN_BOX_CART'], 'BS5_SHOW_PAYPAL_IN_BOX_CART'); ?></td>
                        <td class="dataTableConfig col-right"><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_SHOW_PAYPAL_IN_BOX_CART_INFO; ?></td>
                      </tr>
                      <tr>
                ...
                ?>
                  <div class="admincol_left">
                    <table class="clear tableConfig">
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_PRODBOXES_LINES; ?></h3>
                        </td>
                      </tr>
                      <tr>
                ...
                ?>
                  <div class="admincol_left">
                    <table class="clear tableConfig">
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_SENDMAIL_IF_NEW_REVIEW_HEAD; ?></h3>
                        </td>
                      </tr>
                      <tr>
                        <td class="dataTableConfig col-left"><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_SENDMAIL_IF_NEW_REVIEW; ?></td>
                        <td class="dataTableConfig col-middle"><?php echo xtc_cfg_select_option($yes_no_array, $bs5_conf['BS5_SENDMAIL_IF_NEW_REVIEW'], 'BS5_SENDMAIL_IF_NEW_REVIEW'); ?></td>
                        <td class="dataTableConfig col-right"><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_SENDMAIL_IF_NEW_REVIEW_INFO; ?></td>
                      </tr>
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                      ...
                      <tr>
                        <td class="dataTableConfig col-left"><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_CUSTOMERS_REMIND_ACTIVATION_REMIND; ?></td>
                        <td class="dataTableConfig col-middle"><?php echo xtc_draw_pull_down_menu('configuration[BS5_CUSTOMERS_REMIND_ACTIVATION_REMIND]', $activation_remind, $bs5_conf['BS5_CUSTOMERS_REMIND_ACTIVATION_REMIND']); ?></td>
                        <td class="dataTableConfig col-right"><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_CUSTOMERS_REMIND_ACTIVATION_REMIND_INFO; ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_CHEAPLY_SEE; ?></h3>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_PRODUCT_INQUIRY; ?></h3>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_MODULFUX_ATTRIBUTES_DEFAULT; ?></h3>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_ATTR_PRICE_UPDATER; ?></h3>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_REDUCE_CART; ?></h3>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_AWIDSRATINGBREAKDOWN_1 . TEXT_BS5_TPL_MANAGER_CONFIG_AWIDSRATINGBREAKDOWN_2; ?></h3>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_CONFIG_TRAFFIC_LIGHTS; ?></h3>
                        </td>
                      </tr>
                      <tr>
