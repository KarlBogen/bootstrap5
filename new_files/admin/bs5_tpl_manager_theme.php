              ...
              ?>
                    <table class="clear tableConfig">
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_TPL_MANAGER_THEME_PATHS; ?></h3>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h3><?php echo TEXT_BS5_BOOTSTRAP_THEME_COLOR_MODE; ?></h3>
                        </td>
                      </tr>
                      <tr>
                  ...
                  ?>
                    <table class="clear tableConfig">
                      <tr>
                        <td class="dataTableConfig" colspan="3">
                          <h4><?php echo TEXT_BS5_TPL_MANAGER_FONTS_INFO; ?></h4>
                        </td>
                      </tr>
                      <tr>
                  ...
                  ?>
                    <table class="clear tableConfig">
                      ...
                      <tr>
                        ...
                        <td class="dataTableConfig col-middle"><?php echo xtc_draw_pull_down_menu('configuration[BS5_THEMEMODEL_CUSTOM1]', $themes, $bs5_conf['BS5_THEMEMODEL_CUSTOM1'], 'id="thememodel"');
                                                                echo '<input id="last_selected" type="hidden" value="">'; ?></td>
                      ...
                      ?>
                              <tr>
                                <td class="dataTableConfig col-left"><?php echo defined('TEXT_BS5_TPL_MANAGER_THEME_FIELD_' . $i) ? constant('TEXT_BS5_TPL_MANAGER_THEME_FIELD_' . $i) : TEXT_BS5_TPL_MANAGER_THEME_COLOR;
                                                                      echo defined('COLOR_' . $i) ? constant('COLOR_' . $i) : '';
                                                                      echo '<small>' . TEXT_BS5_TPL_MANAGER_THEME_VAR . $k . '</small>'; ?></td>
                                <td class="dataTableConfig col-middle"><?php echo xtc_draw_input_field('data[custom1][' . $i . '][' . $k . ']', $v, 'class="basic_val" style="float: left;"');
                                                                        echo '<input type="text" class="basic" value="' . $v . '" />'; ?></td>
                                <td class="dataTableConfig col-right"><?php echo defined('TEXT_BS5_TPL_MANAGER_THEME_FIELD_' . $i . '_INFO') ? constant('TEXT_BS5_TPL_MANAGER_THEME_FIELD_' . $i . '_INFO') : TEXT_BS5_TPL_MANAGER_THEME_COLOR_VARS_STANDARD;
                                                                      echo $bs5_custom1['defaults'][$i]; ?></td>
                              </tr>
                            <?php
                            }
                            ...
                            ?>
                              <tr>
                                <td class="dataTableConfig col-left"><?php echo defined('TEXT_BS5_TPL_MANAGER_THEME_FIELD_' . $i) ? constant('TEXT_BS5_TPL_MANAGER_THEME_FIELD_' . $i) : '';
                                                                      echo '<small>' . TEXT_BS5_TPL_MANAGER_THEME_VAR . $k . '</small>'; ?></td>
                  ...
                  ?>
                    <table class="clear tableConfig">
                      ...
                      <tr>
                        <td class="dataTableConfig col-left"><?php echo TEXT_BS5_TPL_MANAGER_THEME_THEMEMODEL_CUSTOM1; ?></td>
                        <td class="dataTableConfig col-middle"><?php echo xtc_draw_pull_down_menu('configuration[BS5_THEMEMODEL_CUSTOM2]', $themes, $bs5_conf['BS5_THEMEMODEL_CUSTOM2'], 'id="thememodel2"');
                                                                echo '<input id="last_selected2" type="hidden" value="">'; ?></td>
                        <td class="dataTableConfig col-right"><?php echo TEXT_BS5_TPL_MANAGER_THEME_THEMEMODEL_CUSTOM1_INFO; ?></td>
                      </tr>
                      <tr>
                        <td class="dataTableConfig col-left">&nbsp;</td>
                      ...
                      ?>
                              <tr>
                                <td class="dataTableConfig col-left"><?php echo defined('TEXT_BS5_TPL_MANAGER_THEME_FIELD_' . $i) ? constant('TEXT_BS5_TPL_MANAGER_THEME_FIELD_' . $i) : TEXT_BS5_TPL_MANAGER_THEME_COLOR;
                                                                      echo defined('COLOR_' . $i) ? constant('COLOR_' . $i) : '';
                                                                      echo '<small>' . TEXT_BS5_TPL_MANAGER_THEME_VAR . $k . '</small>'; ?></td>
                                <td class="dataTableConfig col-middle"><?php echo xtc_draw_input_field('data[custom2][' . $i . '][' . $k . ']', $v, 'class="basic_val" style="float: left;"');
                                                                        echo '<input type="text" class="basic" value="' . $v . '" />'; ?></td>
                                <td class="dataTableConfig col-right"><?php echo defined('TEXT_BS5_TPL_MANAGER_THEME_FIELD_' . $i . '_INFO') ? constant('TEXT_BS5_TPL_MANAGER_THEME_FIELD_' . $i . '_INFO') : TEXT_BS5_TPL_MANAGER_THEME_COLOR_VARS_STANDARD;
                                                                      echo $bs5_custom2['defaults'][$i]; ?></td>
                              </tr>
                            <?php
                            }
                            if (($i > 22 && $i < 33) || $i == 36 || ($i > 66 && $i < 69)) {
